		...
		<div class="row">
			<div class="bg-danger text-white"><?php echo $form_err;?></div>
				<div class="col">
					...
					<p><small class="text-muted h5">Completa tu codigo para ingresar</small></p><br>
				</div>
				<br>
				<div class="row">
					<div class="col">
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="loginCodeLicenceForm">
							<label class="form-label">Código del docente</label>
							<div class="input-group mb-3 <?php echo (!empty($codlicence_err)) ? 'has-error' : ''; ?>">
								...
								<input type="username" class="form-control" name="licencecode" id="licencecode" placeholder="Introduzca el código del docente" value="<?php echo $licencecode; ?>" autocomplete="off">
