    ...
    <section id="piso_3">
        <div class="formStyle">
            ...
            <div class="input-group has-validation">
                ...
                <input type="text" autocomplete="off" name="Email" class="form-control" id="validationEmail" aria-describedby="validationEmailFeedback" placeholder=" Introduce tu correo electrónico" required value="<?php echo $Email; ?>">
            ...
            <div class="input-group has-validation">
                ...
                <input type="text" autocomplete="off" class="form-control" id="validationEmail_2" aria-describedby="validationEmail2Feedback" placeholder=" Introduce nuevamente tu correo electrónico" required value="<?php echo $Email; ?>">
