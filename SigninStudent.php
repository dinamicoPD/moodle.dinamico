    ...
    <section id="piso_3">
        <div class="formStyle">
            ...
            <div class="input-group has-validation">
                ...
                <input type="email" autocomplete="off" name="Email" class="form-control" id="validationEmail" aria-describedby="validationEmailFeedback" placeholder=" Introduce tu correo electrónico" required value="<?php echo $Email; ?>">
            ...
            <div class="input-group has-validation">
                ...
                <input type="email" autocomplete="off" class="form-control" id="validationEmail_2" aria-describedby="validationEmail2Feedback" placeholder=" Introduce nuevamente tu correo electrónico" required value="<?php echo $Email; ?>">
            ...
            <div class="columnasX2">
                <div class="izquierda">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" autocomplete="off" name="FirstName" class="form-control" id="validationName" aria-describedby="validationNameFeedback" placeholder=" Primer nombre" value="<?php echo $FirstName; ?>" required>
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" autocomplete="off" name="LastName" class="form-control" id="validationapellido" aria-describedby="validationapellidoFeedback" placeholder=" Primer apellido" required value="<?php echo $LastName; ?>">
                ...
                <div class="derecha">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" autocomplete="off" name="MiddleName" class="form-control" id="validationName2" aria-describedby="validationName2Feedback" placeholder=" Segundo nombre" value="<?php echo $MiddleName; ?>">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" autocomplete="off" name="SecondLastName" class="form-control" id="validationapellido2" aria-describedby="validationapellido2Feedback" placeholder=" Segundo apellido" required value="<?php echo $SecondLastName; ?>">
    ...
    <section id="piso_6">
        ...
        <div class="formStyle">
            ...
            <div class="input-group has-validation">
                ...
                <input type="password" autocomplete="off" name="validationNewPass" class="form-control" id="validationNewPass" aria-describedby="validationNewPassFeedback" placeholder=" Introduce la nueva contraseña">
            ...
            <div class="input-group has-validation">
                ...
                <input type="password" autocomplete="off" name="validationNewPass2" class="form-control" id="validationNewPass2" aria-describedby="validationNewPass2Feedback" placeholder=" Introduce nuevamente la contraseña">
    ...
    <section id="piso_7">
        ...
        <div class="formStyle">
            ...
            <div class="input-group has-validation">
                ...
                <input type="number" autocomplete="off" name="Phone" class="form-control" id="validationTelefono" aria-describedby="validationTelefonoFeedback" placeholder=" Número telefónico" value="<?php echo $Phone; ?>">
