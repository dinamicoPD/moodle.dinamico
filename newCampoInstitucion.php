<?php
    ...
    foreach($departamentos as $departamento):
        $departamentoFull .= '<option value="'.$departamento['departamentoId'].'">';
        $departamentoFull .= $departamento['departamento'];
        $departamentoFull .= '</option>';
    endforeach;
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="input-group has-validation">
                    ...
                    <select class="form-select formInput" id="departamento_'.$count.'" aria-describedby="departamentoFeedback" onchange="datosInstituto(\'#departamento\', '.$count.')" required>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group has-validation">
                    <span class="input-group-text formIco" id="inputGroupPrepend3">'.$ubicacion.'</span>
                    <select class="form-select formInput" id="ciudad_'.$count.'" aria-describedby="ciudadaFeedback" onchange="datosInstituto(\'#ciudad\', '.$count.')" required>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="input-group has-validation">
                    ...
                    <select class="form-select formInput escuela" id="Instituto_'.$count.'" aria-describedby="InstitutoFeedback" onchange=datosCursos('.$count.') required>
                        <option selected disabled value="">Seleccionar</option>
                    </select>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <input style="visibility: hidden" type="text" class="form-control  formInput" id="otro_'.$count.'" aria-describedby="otroFeedback" oninput=datosCursos('.$count.') placeholder="Otra:">
