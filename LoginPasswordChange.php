	...
	<div class="container">
		<div class="row">
			<div class="col">
				...
				<p><small class="text-muted h5">Ingresa Usuario y Codigo de cartilla</small></p><br>
			</div>
			<br>
			<div class="row">
				<div class="col">
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="loginForm">
						<label class="form-label">Nombre de usuario / email</label><br>
						...
						<div class="input-group mb-3 <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
							...
							<input type="username" class="input-lg form-control" name="username" id="username" placeholder="Introduzca nombre de usuario o email" value="<?php echo $username; ?>" autocomplete="off">
						</div>
						...
						<span class="input-group-text">
							...
							<input type="password" class="input-lg form-control" name="password" id="password" placeholder="Introduzca el código que viene en la portada de su cartilla" value="<?php echo $password; ?>" autocomplete="off">
						</div>
