    ...
    <div class="container">
        <div class="row">
			<div class="col-12">
				...
				<p class="text-center"><strong class="h2">Resumen de Incripción Estudiante</strong></p>
			</div>
		</div>
        <div class="row">
            <div class="col">
                <div class="table-responsive">
                    ...
                    <table class="table">
                        ...
                        <thead class="table-light">
                            <th colspan="2">Información de Grupo y Curso</th>
                        </thead>
                        <tbody>
                            <tr>
                                <td colspan="2"><?php echo $hmtlGroup; ?></td>
                            </tr>
                        </tbody>                        
                    </table>
                    <input class="boton" type="submit" value="Cerrar">
                </form>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        swal({
            title: "Instrucciones",
            text: "A su correo fue enviada su contraseña provisional y su nombre de usuario, al momento de ingresar sus credenciales por primera vez, el sistema automáticamente le solicitara un cambio de contraseña.",
            icon: "info",
